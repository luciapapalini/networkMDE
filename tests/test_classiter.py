...
class citerTest(unittest.TestCase):
    ...
    def test_addition(self):
        ...
        self.assertTrue(self.clist.type == self.obj_type,
                        f"type should be {self.obj_type}, not {self.clist.type}")
        self.assertTrue(self.cdict.type == self.obj_type,
                        f"type should be {self.obj_type}, not {self.cdict.type}")
        self.assertTrue(self.cset.type == self.obj_type,
    ...
    def test_getattr(self):
        ...
        self.assertTrue(self.clist.attribute ==  self.clist_of_attributes,
        ...
        self.assertTrue(self.cset.attribute == self.clist_of_list_set,
                        f"cset attribute should be {self.clist_of_list_set} not {self.cset.attribute}")

        self.assertTrue(self.cdict.attribute == self.clist_of_list_set,
    ...
    def test_method(self):
        ...
        self.assertEqual(self.clist.method(), clist([_+3 for _ in self.list_of_attributes]), 
                            f"method calling: {self.clist.method()} !=  {clist([_+3 for _ in self.list_of_attributes])}")

        self.assertEqual(self.cset.method(), clist([_+3 for _ in self.clist_of_list_set]), 
                            f"method calling: {self.cset.method()} !=  {clist([_+3 for _ in self.clist_of_list_set])}")

        self.assertEqual(self.cdict.method(), clist([_+3 for _ in self.clist_of_list_set]), 
